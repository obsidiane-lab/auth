...
export class AuthClient {
    ...
    async passwordRequest(email) {
        return await this.request('/api/auth/password/forgot', {
            method: 'POST',
            headers: this.buildCsrfHeaders(),
    ...
    async inviteUser(email) {
        return await this.request('/api/auth/invite', {
            method: 'POST',
            headers: this.buildCsrfHeaders(),
            body: JSON.stringify({ email }),
        });
    ...
    async completeInvite(token, password, confirmPassword) {
        return await this.request('/api/auth/invite/complete', {
            method: 'POST',
            headers: this.buildCsrfHeaders(),
            body: JSON.stringify({
                token,
    ...
    async listInvites() {
        return await this.request('/api/invite_users', {
            method: 'GET',
    ...
    async getInvite(id) {
        return await this.request(`/api/invite_users/${id}`, {
            method: 'GET',
            headers: this.headers(),
        });
    }
