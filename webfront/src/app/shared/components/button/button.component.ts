...
export class ButtonComponent implements OnInit {
  ...
  baseClasses =
    'font-semibold focus-visible:outline-none relative inline-flex items-center justify-center gap-2 focus-visible:ring-2 focus-visible:ring-offset-2 active:translate-y-px transition disabled:pointer-events-none disabled:opacity-50';
